...
def plot_population_responses(trial_ts, spike_times_per_unit):
    ...
    # Plot scatter panels
    plot_scatter_panel(ax1, pre_activity, post_activity,
                      "pre-stimulus activity (sp/s)", "post-stimulus activity (sp/s)",
                      x_err=pre_sem, y_err=post_sem,
    ...
    plot_scatter_panel(ax2, stat_stimulus_response, move_stimulus_response,
